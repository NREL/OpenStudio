...
macro( CREATE_TEST_TARGETS BASE_NAME SRC DEPENDENCIES )
  IF( BUILD_TESTING )
    ...
    SET(LINK_BASE_NAME true)
    IF ($BASE_NAME_TYPE EQUAL EXECUTABLE)
      SET(LINK_BASE_NAME false)
    ENDIF()
    message("${BASE_NAME}, ${LINK_BASE_NAME}, ${BASE_NAME_TYPE}")
    IF(${LINK_BASE_NAME})
      message("linking")
    ELSEIF()
      message("not linking")
...
MACRO( MAKE_SWIG_TARGET NAME SIMPLENAME KEY_I_FILE I_FILES PARENT_TARGET PARENT_SWIG_TARGETS)
  ...
  IF (RUBY_VERSION_MAJOR EQUAL "2" AND CMAKE_CL_64)
  ...
  ELSEIF(RUBY_VERSION_MAJOR EQUAL "2" AND CMAKE_CL_64)
