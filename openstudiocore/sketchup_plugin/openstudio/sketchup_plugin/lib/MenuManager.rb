...
require("lib/IdfImporter")
require("lib/GbXMLImporter")
require("lib/SddImporter")
require("lib/OpenStudioImporter")
require("lib/dialogs/PluginInspectorDialog")
require("lib/dialogs/ColorScaleInterface")
require("lib/dialogs/AnimationSettingsInterface")
require("lib/dialogs/PreferencesInterface")
require("lib/dialogs/AboutInterface")
require("lib/dialogs/SurfaceSearchInterface")
require("lib/dialogs/SurfaceMatchingInterface")
require("lib/dialogs/LooseGeometryInterface")
require("lib/tools/InfoTool")
require("lib/tools/NewShadingSurfaceGroupTool")
require("lib/tools/NewInteriorPartitionSurfaceGroupTool")
require("lib/tools/NewDaylightingControlTool")
require("lib/tools/NewGlareSensorTool")
require("lib/tools/NewIlluminanceMapTool")
require("lib/tools/NewLuminaireTool")
require("lib/tools/NewSpaceTool")
