...
TEST_F(AnalysisFixture, DesignOfExperiments_Construction) {
  ...
  EXPECT_EQ(DesignOfExperimentsType(DesignOfExperimentsType::FullFactorial),
            algorithm.designOfExperimentsOptions().designType());
}
