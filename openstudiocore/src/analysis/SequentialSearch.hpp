...
class ANALYSIS_API SequentialSearch : public OpenStudioAlgorithm {
 public:
  ...
  /** Returns a Table (see utilities/document/Table.hpp) that summarizes the results of analysis. 
   *  Throws if analysis.algorithm() != *this. In general, reports the variable values, objective 
   *  function values, and tags for each DataPoint, where the only tags reported are those 
   *  generated by SequentialSearch. */
