...
%template(HeaderInfoPtr) boost::shared_ptr<openstudio::radiance::HeaderInfo>;
 
// create an instantiation of the vector class
%template(HeaderInfoVector) std::vector< boost::shared_ptr<openstudio::radiance::HeaderInfo> >;
