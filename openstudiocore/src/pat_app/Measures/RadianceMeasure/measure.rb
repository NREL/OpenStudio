...
class RadianceMeasure < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    chs << 'Simple'
    chs << 'Debug'
    image_type = OpenStudio::Ruleset::OSArgument.makeChoiceArgument('image_type', chs, true)
    image_type.setDisplayName('Image Type')
    image_type.setDefaultValue('Simple')
    image_type.setDescription('Simple renderings of each daylighting control point and glare sensor are generated by default. Debug option creates images of each window group.')
    args << image_type
  ...
  def run(model, runner, user_arguments)
    ...
    image_type = runner.getStringArgumentValue('image_type', user_arguments)
    ...
    def calculateDaylightCoeffecients(radPath, sim_cores, t_catCommand, options_tregVars,
                                      ...
                                      options_vmx, rad_settings, procsUsed, runner, image_type)
...
#             end
    ...
    def genImages(radPath, runner, site_latitude, site_longitude, site_meridian, catCommand, image_type)
...
#    end # writeReport()
    ...
    options_klemsDensity, options_skyvecDensity, options_dmx, options_vmx, rad_settings, procsUsed, runner, image_type)
    ...
    # make check images 
    genImages(radPath, runner, site_latitude, site_longitude, site_meridian, catCommand, image_type)
