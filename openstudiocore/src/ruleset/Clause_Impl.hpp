...
#ifndef RULESET_CLAUSE_IMPL_HPP
#define RULESET_CLAUSE_IMPL_HPP
...
namespace detail {
  ...
  class RULESET_API Clause_Impl : public RulesetObject_Impl {
   ...
   public:
    ...
    Clause_Impl(const UUID& uuid, const UUID& versionUUID);

    Clause_Impl(const QDomElement& element);
