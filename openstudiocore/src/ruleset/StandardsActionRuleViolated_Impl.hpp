...
#ifndef RULESET_STANDARDSACTIONRULEVIOLATED_IMPL_HPP
#define RULESET_STANDARDSACTIONRULEVIOLATED_IMPL_HPP
...
class ActionRuleViolated;

namespace detail {

  class RULESET_API StandardsActionRuleViolated_Impl : public StandardsActionRuleResult_Impl {
   ...
   public:
    ...
    StandardsActionRuleViolated_Impl(const StandardsFilterObjectAttribute& attributeTest);

    StandardsActionRuleViolated_Impl(const StandardsFilterObjectAttribute& attributeTest,
                                     const UUID& uuid,
                                     const UUID& versionUUID);

    StandardsActionRuleViolated_Impl(const QDomElement& element);
   ...
   protected:
   private:
    REGISTER_LOGGER("Ruleset.ActionRuleViolated");
  };
...
#endif // RULESET_STANDARDSACTIONRULEVIOLATED_IMPL_HPP
