 ...
 *        <li> ExteriorFuelEquipment (ModelObject)
 *        <li> ExteriorWaterEquipment (ModelObject)
 ...
 *    <li> ExteriorFuelEquipmentDefinition (ResourceObject)
 *    <li> ExteriorWaterEquipmentDefinition (ResourceObject)
