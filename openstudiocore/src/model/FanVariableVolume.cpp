...
namespace detail {
  ...
  {
    BOOST_ASSERT(idfObject.iddObject().type() == FanVariableVolume::iddObjectType());
  }
  ...
  {
    BOOST_ASSERT(other.iddObject().type() == FanVariableVolume::iddObjectType());
  }
...
{
  BOOST_ASSERT(getImpl<detail::FanVariableVolume_Impl>());
