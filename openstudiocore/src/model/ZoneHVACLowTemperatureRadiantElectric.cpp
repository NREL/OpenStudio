...
namespace detail {
  ...
  boost::optional<ThermalZone> ZoneHVACLowTemperatureRadiantElectric_Impl::thermalZone()
  {
...
boost::optional<ThermalZone> ZoneHVACLowTemperatureRadiantElectric::thermalZone()
{
