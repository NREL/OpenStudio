...
/** CoilWaterHeatingAirToWaterHeatPump is a WaterToAirComponent that wraps the OpenStudio IDD object 'OS:Coil:WaterHeating:AirToWaterHeatPump'. */
class MODEL_API CoilWaterHeatingAirToWaterHeatPump : public WaterToAirComponent {
 public:
