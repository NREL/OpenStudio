...
namespace detail {
  ...
  const std::vector<std::string>& ThermalZone_Impl::outputVariableNames() const
  {
    ...
    if (result.empty()){
      result.push_back("Zone Site Outdoor Air Drybulb Temperature");
      result.push_back("Zone Outdoor Air Drybulb Temperature");
      result.push_back("Zone Outdoor Air Wetbulb Temperature");
      result.push_back("Zone Outdoor Air Site Wind Speed");
      ...
      result.push_back("Zone Total Internal Latent Gain Energy Energy");
      ...
      result.push_back("Zone Exterior Windows Total Transmitted Site Diffuse Solar Radiation Rate per Area Radiation Rate");
      result.push_back("Zone Interior Windows Total Transmitted Site Diffuse Solar Radiation Rate per Area Radiation Rate");
      ...
      result.push_back("Zone Exterior Windows Total Transmitted Site Diffuse Solar Radiation Rate per Area Radiation Energy");
      result.push_back("Zone Interior Windows Total Transmitted Site Diffuse Solar Radiation Rate per Area Radiation Energy");
      ...
      result.push_back("Zone Infiltration Sensible Heat Loss Energy Energy");
      result.push_back("Zone Infiltration Sensible Heat Gain Energy Energy");
      result.push_back("Zone Infiltration Sensible Heat Gain Energy Energy");
      result.push_back("Zone Infiltration Latent Heat Gain Energy Energy");
      result.push_back("Zone Infiltration Total Heat Loss Energy Energy");
      result.push_back("Zone Infiltration Total Heat Gain Energy Energy");
      ...
      result.push_back("Zone Mechanical Ventilation No Load Heat Removal Energy Energy");
      result.push_back("Zone Mechanical Ventilation Cooling Load Increase Energy Energy");
      result.push_back("Zone Mechanical Ventilation Cooling Load Increase Energy Due to Overheating Energy");
      result.push_back("Zone Mechanical Ventilation Cooling Load Decrease Energy Energy");
      result.push_back("Zone Mechanical Ventilation No Load Heat Addition Energy Energy");
      result.push_back("Zone Mechanical Ventilation No Load Heat Removal Energy Energy");
      result.push_back("Zone Mechanical Ventilation Cooling Load Increase Energy Energy");
      result.push_back("Zone Mechanical Ventilation Cooling Load Increase Energy Due to Overheating Energy");
      result.push_back("Zone Mechanical Ventilation Cooling Load Decrease Energy Energy");
      result.push_back("Zone Mechanical Ventilation No Load Heat Addition Energy Energy");
      result.push_back("Zone Mechanical Ventilation Heating Load Increase Energy Energy");
      result.push_back("Zone Mechanical Ventilation Heating Load Increase Energy Due to Overcooling Energy");
      result.push_back("Zone Mechanical Ventilation Heating Load Decrease Energy Energy");
