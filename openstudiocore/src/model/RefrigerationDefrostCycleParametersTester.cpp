...
/// @cond
RefrigerationDefrostCycleParametersTester::RefrigerationDefrostCycleParametersTester(std::shared_ptr<detail::RefrigerationDefrostCycleParametersTester_Impl> impl)
  : ModelObject(impl)
{}
/// @endcond
