...
namespace detail {
  ...
  {
    BOOST_ASSERT(idfObject.iddObject().type() == StandardGlazing::iddObjectType());
  }
  ...
  {
    BOOST_ASSERT(other.iddObject().type() == StandardGlazing::iddObjectType());
  }
...
{
  BOOST_ASSERT(getImpl<detail::StandardGlazing_Impl>());
