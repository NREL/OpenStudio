  ...
  : ModelObject(CoolingTowerPerformanceYorkCalc::iddObjectType(),model)
{
  ...
  // setMinimumInletAirWetBulbTemperature();
  // setMaximumInletAirWetBulbTemperature();
  // setMinimumRangeTemperature();
  // setMaximumRangeTemperature();
  // setMinimumApproachTemperature();
  // setMaximumApproachTemperature();
  // setMinimumWaterFlowRateRatio();
  // setMaximumWaterFlowRateRatio();
  // setMaximumLiquidtoGasRatio();
  // setCoefficient1();
  // setCoefficient2();
  // setCoefficient3();
  // setCoefficient4();
