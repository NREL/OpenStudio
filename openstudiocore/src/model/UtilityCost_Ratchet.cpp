...
{
  BOOST_ASSERT(idfObject.iddObject().type() == UtilityCost_Ratchet::iddObjectType());
}
...
{
  BOOST_ASSERT(other.iddObject().type() == UtilityCost_Ratchet::iddObjectType());
}
...
{
  BOOST_ASSERT(getImpl<detail::UtilityCost_Ratchet_Impl>());
}
