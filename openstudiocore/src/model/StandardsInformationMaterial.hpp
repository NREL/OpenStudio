...
class MODEL_API StandardsInformationMaterial : public ModelObject {
 public:
  ...
  /** Returns the category of this material, e.g. 'Plastering Materials' 'Composite', or 'Roofing'. */
  ...
  /** Returns a list of suggestions for standards identifier, filters list by material standard if it is set. */
  ...
  /** Returns a list of suggestions for composite framing material, filters list by material standard if it is set. */
  ...
  /** Returns a list of suggestions for composite framing configurations, filters list by material standard if it is set. */
  ...
  /** Returns a list of suggestions for composite framing depths, filters list by material standard if it is set. */
  ...
  /** Returns a list of suggestions for composite framing sizes, filters list by material standard if it is set. */
  ...
  /** Returns a list of suggestions for cavity insulation, filters list by material standard if it is set. */
