...
ScheduleTypeRegistrySingleton::ScheduleTypeRegistrySingleton()
{
  ...
  { 
    ...
    {"RefrigerationCondenserEvaporativeCooled","Availability","evaporativeCondenserAvailabilitySchedule",false,"Availability",0.0,1.0},
...
// TODO: Need to double check these
    ...
    {"RefrigerationWalkIn","Restocking","restockingSchedule",true,"WattsPerMeter",0.0,OptionalDouble()},
