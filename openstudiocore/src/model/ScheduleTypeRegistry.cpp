...
ScheduleTypeRegistrySingleton::ScheduleTypeRegistrySingleton()
{
  ...
  const ScheduleType scheduleTypes[] =
  {
    ...
    {"ElectricLoadCenterDistribution", "Storage Discharge Power Fraction", "trackScheduleSchemeSchedule",true,"",0.0,1.0},
    {"ElectricLoadCenterDistribution", "Storage Control Utility Demand Target Fraction", "trackScheduleSchemeSchedule",true,"",-1.0,1.0},
