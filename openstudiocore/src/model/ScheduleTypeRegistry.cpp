...
ScheduleTypeRegistrySingleton::ScheduleTypeRegistrySingleton()
{
  const ScheduleType scheduleTypes[] =
  {
    ...
    {"RefrigerationCase","Availability","availabilitySchedule",,,,},
    {"RefrigerationCase","Case Lighting","caseLightingSchedule",,,,},
    {"RefrigerationCase","Case Defrost","caseDefrostSchedule",,,,},
    {"RefrigerationCase","Case Defrost Drip-Down","caseDefrostDripDownSchedule",,,,},
    {"RefrigerationCase","Refrigerated Case Restocking","refrigeratedCaseRestockingSchedule",,,,},
    {"RefrigerationCase","Case Credit Fraction","caseCreditFractionSchedule",,,,},
