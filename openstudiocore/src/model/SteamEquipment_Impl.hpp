...
namespace detail {
  ...
  class MODEL_API SteamEquipment_Impl : public SpaceLoadInstance_Impl {
    ...
    Q_PROPERTY(boost::optional<openstudio::model::ModelObject> steamEquipmentDefinition READ steamEquipmentDefinitionAsModelObject WRITE setSteamEquipmentDefinitionAsModelObject);
