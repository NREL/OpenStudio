...
namespace detail {
  ...
  class MODEL_API HotWaterEquipment_Impl : public SpaceLoadInstance_Impl {
    ...
    Q_PROPERTY(boost::optional<openstudio::model::ModelObject> hotWaterEquipmentDefinition READ hotWaterEquipmentDefinitionAsModelObject WRITE setHotWaterEquipmentDefinitionAsModelObject);
