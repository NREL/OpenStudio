...
namespace detail {
  ...
  class MODEL_API CoolingTowerPerformanceCoolTools_Impl : public ModelObject_Impl {
   ...
   public:
    ...
    CoolingTowerPerformanceCoolTools_Impl(const IdfObject& idfObject,
                                          Model_Impl* model,
                                          bool keepHandle);

    CoolingTowerPerformanceCoolTools_Impl(const openstudio::detail::WorkspaceObject_Impl& other,
                                          Model_Impl* model,
                                          bool keepHandle);

    CoolingTowerPerformanceCoolTools_Impl(const CoolingTowerPerformanceCoolTools_Impl& other,
                                          Model_Impl* model,
                                          bool keepHandle);
