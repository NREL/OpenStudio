...
namespace detail {
  ...
  {
    BOOST_ASSERT(idfObject.iddObject().type() == HeatBalanceAlgorithm::iddObjectType());
  }
  ...
  {
    BOOST_ASSERT(other.iddObject().type() == HeatBalanceAlgorithm::iddObjectType());
  }
...
{
  BOOST_ASSERT(getImpl<detail::HeatBalanceAlgorithm_Impl>());
