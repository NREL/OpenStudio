...
namespace detail {
  ...
  {
    BOOST_ASSERT(idfObject.iddObject().type() == PumpConstantSpeed::iddObjectType());
  }
  ...
  {
    BOOST_ASSERT(other.iddObject().type() == PumpConstantSpeed::iddObjectType());
  }
...
{
  BOOST_ASSERT(getImpl<detail::PumpConstantSpeed_Impl>());
