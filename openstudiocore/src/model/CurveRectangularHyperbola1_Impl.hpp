...
namespace detail {
  ...
  class MODEL_API CurveRectangularHyperbola1_Impl : public Curve_Impl {
   ...
   public:
    ...
    CurveRectangularHyperbola1_Impl(const openstudio::detail::WorkspaceObject_Impl& other,
                                    Model_Impl* model,
                                    bool keepHandle);

    CurveRectangularHyperbola1_Impl(const CurveRectangularHyperbola1_Impl& other,
                                    Model_Impl* model,
                                    bool keepHandle);

    virtual ~CurveRectangularHyperbola1_Impl() {}
