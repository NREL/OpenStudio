...
#ifndef PROJECT_STANDARDSFILTEROBJECTDOUBLEATTRIBUTERECORD_IMPL_HPP
#define PROJECT_STANDARDSFILTEROBJECTDOUBLEATTRIBUTERECORD_IMPL_HPP
...
namespace detail {
  ...
  class PROJECT_API StandardsFilterObjectDoubleAttributeRecord_Impl : public StandardsFilterObjectAttributeRecord_Impl
  {
    ...
    public:
      ...
      /// constructors
      StandardsFilterObjectDoubleAttributeRecord_Impl(
      ...
      StandardsFilterObjectDoubleAttributeRecord_Impl(const QSqlQuery& query, 
                                                      const ProjectDatabase& projectDatabase);

      virtual ~StandardsFilterObjectDoubleAttributeRecord_Impl() {}

      /// get the filter from the record
      openstudio::ruleset::StandardsFilterObjectDoubleAttribute standardsFilterObjectDoubleAttribute() const;
    ...
    private:
      ...
      openstudio::standardsinterface::DoubleAttribute m_attributeName;
      double m_attributeValue;
      openstudio::ruleset::RulesetNumericalPredicate m_predicate;
      std::string m_attributeUnits;

      openstudio::standardsinterface::DoubleAttribute m_lastAttributeName;
...
#endif // PROJECT_STANDARDSFILTEROBJECTDOUBLEATTRIBUTERECORD_IMPL_HPP
