...
#ifndef PROJECT_MODELRULESETRECORD_IMPL_HPP
#define PROJECT_MODELRULESETRECORD_IMPL_HPP
...
namespace detail {
  ...
  class PROJECT_API ModelRulesetRecord_Impl : public RulesetRecord_Impl
  {
    ...
    public:
      ...
      /// constructors
      ModelRulesetRecord_Impl(const openstudio::ruleset::ModelRuleset& modelRuleset, const ProjectDatabase& projectDatabase);

      /// constructor from query, throws if bad query
      ModelRulesetRecord_Impl(const QSqlQuery& query, const ProjectDatabase& projectDatabase);

      virtual ~ModelRulesetRecord_Impl() {}
...
#endif // PROJECT_MODELRULESETRECORD_IMPL_HPP
