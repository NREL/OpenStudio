...
#ifndef PROJECT_MODELOBJECTFILTERBOOLEANATTRIBUTERECORD_IMPL_HPP
#define PROJECT_MODELOBJECTFILTERBOOLEANATTRIBUTERECORD_IMPL_HPP
...
namespace detail {
  ...
  class PROJECT_API ModelObjectFilterBooleanAttributeRecord_Impl : public ModelObjectFilterAttributeRecord_Impl
  {
    ...
    public:
      ...
      /// constructors
      ModelObjectFilterBooleanAttributeRecord_Impl(const openstudio::ruleset::ModelObjectFilterBooleanAttribute& modelObjectFilterBooleanAttribute, const ProjectDatabase& projectDatabase);

      /// constructor from query, throws if bad query
      ModelObjectFilterBooleanAttributeRecord_Impl(const QSqlQuery& query, const ProjectDatabase& projectDatabase);

      virtual ~ModelObjectFilterBooleanAttributeRecord_Impl() {}
...
#endif // PROJECT_MODELOBJECTFILTERBOOLEANATTRIBUTERECORD_IMPL_HPP
