...
#ifndef PROJECT_MODELOBJECTFILTERSTRINGATTRIBUTERECORD_IMPL_HPP
#define PROJECT_MODELOBJECTFILTERSTRINGATTRIBUTERECORD_IMPL_HPP
...
namespace detail {
  ...
  class PROJECT_API ModelObjectFilterStringAttributeRecord_Impl : public ModelObjectFilterAttributeRecord_Impl
  {
    ...
    public:
      ...
      /// constructors
      ModelObjectFilterStringAttributeRecord_Impl(const openstudio::ruleset::ModelObjectFilterStringAttribute& modelObjectFilterStringAttribute, const ProjectDatabase& projectDatabase);

      /// constructor from query, throws if bad query
      ModelObjectFilterStringAttributeRecord_Impl(const QSqlQuery& query, const ProjectDatabase& projectDatabase);

      virtual ~ModelObjectFilterStringAttributeRecord_Impl() {}
...
#endif // PROJECT_MODELOBJECTFILTERSTRINGATTRIBUTERECORD_IMPL_HPP
