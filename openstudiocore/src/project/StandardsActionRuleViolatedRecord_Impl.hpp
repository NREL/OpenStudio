...
#ifndef PROJECT_STANDARDSACTIONRULEVIOLATEDRECORD_IMPL_HPP
#define PROJECT_STANDARDSACTIONRULEVIOLATEDRECORD_IMPL_HPP
...
namespace detail {
  ...
  class PROJECT_API StandardsActionRuleViolatedRecord_Impl : public StandardsActionRuleResultRecord_Impl
  {
    ...
    public:
      ...
      /// constructors
      StandardsActionRuleViolatedRecord_Impl(const openstudio::ruleset::StandardsActionRuleViolated& standardsActionRuleViolated, const ProjectDatabase& projectDatabase);

      /// constructor from query, throws if bad query
      StandardsActionRuleViolatedRecord_Impl(const QSqlQuery& query, const ProjectDatabase& projectDatabase);

      virtual ~StandardsActionRuleViolatedRecord_Impl() {}
...
#endif // PROJECT_STANDARDSACTIONRULEVIOLATEDRECORD_IMPL_HPP
