...
namespace openstudio{
  ...
  public:
    ...
    /// returns true if can restore a previously started session
    ...
    /// returns true if server and all workers have been completely shut down
    ...
    bool waitForServer(int msec=30000);
    ...
    bool waitForWorkers(int msec=30000);
    ...
    bool waitForTerminate(int msec=30000);
