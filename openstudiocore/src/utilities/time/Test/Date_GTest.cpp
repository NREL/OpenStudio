...
TEST(Date, NthDayOfWeekInMonthAssumedYear)
{
  ...
  EXPECT_TRUE(firstSundayInJanuary <= Date(MonthOfYear::Jan, 7));

  Date secondSundayInJanuary = Date::fromNthDayOfMonth(NthDayOfWeekInMonth::second, DayOfWeek::Sunday, MonthOfYear::Jan);
  EXPECT_EQ(DayOfWeek(DayOfWeek::Sunday), secondSundayInJanuary.dayOfWeek());
  EXPECT_EQ(MonthOfYear(MonthOfYear::Jan), secondSundayInJanuary.monthOfYear());
  EXPECT_TRUE(secondSundayInJanuary <= Date(MonthOfYear::Jan, 14));
...
TEST(Date, NthDayOfWeekInMonthQualifiedYear)
{
  ...
  EXPECT_EQ(DayOfWeek(DayOfWeek::Sunday), firstSundayInJanuary.dayOfWeek());
  EXPECT_EQ(MonthOfYear(MonthOfYear::Jan), firstSundayInJanuary.monthOfYear());
  EXPECT_TRUE(firstSundayInJanuary == Date(MonthOfYear::Jan, 6, 2008));

  Date secondSundayInJanuary = Date::fromNthDayOfMonth(NthDayOfWeekInMonth::second, DayOfWeek::Sunday, MonthOfYear::Jan, 2008);
  EXPECT_EQ(DayOfWeek(DayOfWeek::Sunday), secondSundayInJanuary.dayOfWeek());
  EXPECT_EQ(MonthOfYear(MonthOfYear::Jan), secondSundayInJanuary.monthOfYear());
