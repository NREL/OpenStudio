...
/// Helper function to construct Vector from std::vector<long>, subtracts newCenter from all values first.
UTILITIES_API Vector createVector(const std::vector<long>& values, long newCenter = 0);
