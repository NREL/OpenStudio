...
namespace openstudio{
  ...
  /// subtract all holes from polygon, requires that all vertices are in counter clockwise order on the z = 0 plane (e.g. in face coordinates) 
  ...
  /// returns true polygon intersects iteself, requires that all vertices are in counter clockwise order on the z = 0 plane (e.g. in face coordinates) 
  ...
  /// returns true if polygon1 intersects polygon2, requires that all vertices are in counter clockwise order on the z = 0 plane (e.g. in face coordinates) 
  ...
  /// returns true if geometry1 is completely within polygon2, requires that all vertices are in counter clockwise order on the z = 0 plane (e.g. in face coordinates) 
