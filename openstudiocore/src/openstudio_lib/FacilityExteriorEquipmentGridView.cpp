...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new FacilityExteriorEquipmentGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::FacilityExteriorEquipmentGridController::filterChanged);
  ...
  void FacilityExteriorEquipmentGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void FacilityExteriorEquipmentGridView::disableFilter()
  {
  ...
  void FacilityExteriorEquipmentGridController::filterChanged(const QString & text)
  {
