...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new SpacesLoadsGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::SpacesLoadsGridController::filterChanged);
  ...
  std::vector<model::ModelObject> SpacesLoadsGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void SpacesLoadsGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void SpacesLoadsGridView::disableFilter()
  {
    m_filterLabel->setEnabled(false);
    m_filters->setEnabled(false);
  }

  void SpacesLoadsGridView::onDropZoneItemClicked(OSItem* item)
  {
  }
  ...
  void SpacesLoadsGridController::filterChanged(const QString & text)
  {
  ...
  SpacesLoadsGridView * SpacesLoadsGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<SpacesLoadsGridView *>(this->parent()->parent());
  }
  ...
  void SpacesLoadsGridController::onComboBoxIndexChanged(int index)
  {
  }
