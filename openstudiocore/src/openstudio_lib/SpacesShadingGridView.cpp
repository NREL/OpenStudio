...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new SpacesShadingGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::SpacesShadingGridController::filterChanged);
  ...
  std::vector<model::ModelObject> SpacesShadingGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void SpacesShadingGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void SpacesShadingGridView::disableFilter()
  {
    m_filterLabel->setEnabled(false);
    m_filters->setEnabled(false);
  }

  void SpacesShadingGridView::onDropZoneItemClicked(OSItem* item)
  {
  }
  ...
  void SpacesShadingGridController::filterChanged(const QString & text)
  {
  ...
  SpacesShadingGridView * SpacesShadingGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<SpacesShadingGridView *>(this->parent()->parent());
  }
  ...
  void SpacesShadingGridController::onComboBoxIndexChanged(int index)
  {
  }
