...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new SpacesSurfacesGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::SpacesSurfacesGridController::filterChanged);
  ...
  std::vector<model::ModelObject> SpacesSurfacesGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void SpacesSurfacesGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void SpacesSurfacesGridView::disableFilter()
  {
    m_filterLabel->setEnabled(false);
    m_filters->setEnabled(false);
  }

  void SpacesSurfacesGridView::onDropZoneItemClicked(OSItem* item)
  {
  }
  ...
  void SpacesSurfacesGridController::filterChanged(const QString & text)
  {
  ...
  SpacesSurfacesGridView * SpacesSurfacesGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<SpacesSurfacesGridView *>(this->parent()->parent());
  }
  ...
  void SpacesSurfacesGridController::onComboBoxIndexChanged(int index)
  {
  }
