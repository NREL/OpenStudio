    ...
    m_modelObject(modelObject)
{
  ...
  m_modelObject.getImpl<model::detail::ModelObject_Impl>().get()->model::detail::ModelObject_Impl::onChange.connect<ModelObjectItem, &ModelObjectItem::onObjectChanged>(this);
