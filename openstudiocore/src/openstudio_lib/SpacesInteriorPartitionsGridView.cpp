...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new SpacesInteriorPartitionsGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::SpacesInteriorPartitionsGridController::filterChanged);
  ...
  std::vector<model::ModelObject> SpacesInteriorPartitionsGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void SpacesInteriorPartitionsGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void SpacesInteriorPartitionsGridView::disableFilter()
  {
    m_filterLabel->setEnabled(false);
    m_filters->setEnabled(false);
  }

  void SpacesInteriorPartitionsGridView::onDropZoneItemClicked(OSItem* item)
  {
  }
  ...
  void SpacesInteriorPartitionsGridController::filterChanged(const QString & text)
  {
  ...
  SpacesInteriorPartitionsGridView * SpacesInteriorPartitionsGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<SpacesInteriorPartitionsGridView *>(this->parent()->parent());
  }
  ...
  void SpacesInteriorPartitionsGridController::onComboBoxIndexChanged(int index)
  {
  }
