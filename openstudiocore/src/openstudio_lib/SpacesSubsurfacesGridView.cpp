...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new SpacesSubsurfacesGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::SpacesSubsurfacesGridController::filterChanged);
  ...
  std::vector<model::ModelObject> SpacesSubsurfacesGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void SpacesSubsurfacesGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void SpacesSubsurfacesGridView::disableFilter()
  {
  ...
  void SpacesSubsurfacesGridController::filterChanged(const QString & text)
  {
  ...
  SpacesSubsurfacesGridView * SpacesSubsurfacesGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<SpacesSubsurfacesGridView *>(this->parent()->parent());
  }
  ...
  void SpacesSubsurfacesGridController::onComboBoxIndexChanged(int index)
  {
  }
