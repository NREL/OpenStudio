...
namespace openstudio {
  ...
  FacilityBuildingGridView::FacilityBuildingGridView(bool isIP, const model::Model & model, QWidget * parent)
    : QWidget(parent),
    m_isIP(isIP)
  {
    ...
    m_gridController = new FacilityBuildingGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::FacilityBuildingGridController::filterChanged);
  ...
  std::vector<model::ModelObject> FacilityBuildingGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void FacilityBuildingGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void FacilityBuildingGridView::disableFilter()
  {
    m_filterLabel->setEnabled(false);
    m_filters->setEnabled(false);
  }

  void FacilityBuildingGridView::onDropZoneItemClicked(OSItem* item)
  {
  }

  FacilityBuildingGridController::FacilityBuildingGridController(bool isIP,
  ...
  void FacilityBuildingGridController::setCategoriesAndFields()
  {
  ...
  void FacilityBuildingGridController::filterChanged(const QString & text)
  {
  ...
  FacilityBuildingGridView * FacilityBuildingGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<FacilityBuildingGridView *>(this->parent()->parent());
  }

  void FacilityBuildingGridController::categorySelected(int index)
  {
  ...
  void FacilityBuildingGridController::addColumns(const QString &category, std::vector<QString> & fields)
  {
    ...
    for (const auto &field : fields) {
      ...
      if (field == NAME) {
        ...
        connect(checkbox.data(), &QCheckBox::stateChanged, this, &FacilityBuildingGridController::selectAllStateChanged);
  ...
  QString FacilityBuildingGridController::getColor(const model::ModelObject & modelObject)
  {
  ...
  void FacilityBuildingGridController::checkSelectedFields()
  {
  ...
  void FacilityBuildingGridController::onItemDropped(const OSItemId& itemId)
  {
  ...
  void FacilityBuildingGridController::refreshModelObjects()
  {
  ...
  void FacilityBuildingGridController::onComboBoxIndexChanged(int index)
  {
  }
