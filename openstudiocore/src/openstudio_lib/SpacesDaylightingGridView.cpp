...
namespace openstudio {
    ...
    m_isIP(isIP)
  {
    ...
    m_gridController = new SpacesDaylightingGridController(m_isIP, "Space Types", IddObjectType::OS_SpaceType, model, spaceTypeModelObjects);
  ...
  isConnected = connect(m_filters, &QComboBox::currentTextChanged, m_gridController, &openstudio::SpacesDaylightingGridController::filterChanged);
  ...
  std::vector<model::ModelObject> SpacesDaylightingGridView::selectedObjects() const
  {
    return m_gridController->selectedObjects();
  }

  void SpacesDaylightingGridView::enableFilter()
  {
    m_filterLabel->setEnabled(true);
    m_filters->setEnabled(true);
  }

  void SpacesDaylightingGridView::disableFilter()
  {
    m_filterLabel->setEnabled(false);
    m_filters->setEnabled(false);
  }

  void SpacesDaylightingGridView::onDropZoneItemClicked(OSItem* item)
  {
  }
  ...
  void SpacesDaylightingGridController::filterChanged(const QString & text)
  {
  ...
  SpacesDaylightingGridView * SpacesDaylightingGridController::gridView()
  {
    OS_ASSERT(qobject_cast<OSGridView *>(this->parent()));

    return qobject_cast<SpacesDaylightingGridView *>(this->parent()->parent());
  }
  ...
  void SpacesDaylightingGridController::onComboBoxIndexChanged(int index)
  {
  }
