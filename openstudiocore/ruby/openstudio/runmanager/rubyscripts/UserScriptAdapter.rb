...
optparse = OptionParser.new do|opts|
  ...
  opts.on('-s','--lastSqlFilePath LASTSQLFILEPATH', String, "Path to last SqlFile generated by this workflow." ) do |lastSqlFilePath|
    options[:lastSqlFilePath] = lastSqlFilePath
  end
...
if lastSqlFilePath = options[:lastSqlFilePath]
  runner.setLastSqlFilePath(OpenStudio::Path.new(lastSqlFilePath))
end
