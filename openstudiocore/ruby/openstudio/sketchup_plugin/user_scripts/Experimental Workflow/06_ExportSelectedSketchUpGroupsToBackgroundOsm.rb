...
class ExportSelectedSketchUpGroupsToOsm < OpenStudio::Ruleset::UtilityUserScript

  # override name to return the name of your script
  def name
    return "Export Selected SketchUp Groups to OSM in background"
  end
  ...
  def run(runner, user_arguments)
    ...
    #this script acts on the selection vs. the entire model.
    ...
    #because this script only operates on a selected, I don't delete spaces in OSM that don't have an equivalent SketchUp group.
...
ExportSelectedSketchUpGroupsToOsm.new.registerWithApplication
