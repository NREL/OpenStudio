...
def equip_sizing_check(model, sql)
  ...
  #heating equipment
    ...
    boilers.each do |boiler|    
      ...
      timestep_boiler_cap = get_timeseries_array(sql, $env_period, $zone_time_step, "Boiler Heating Output Rate", boiler.name.get)
    ...
    heating_coils.each do |heating_coil|
      ...
      timestep_heating_coil_cap = get_timeseries_array(sql, $env_period, $zone_time_step, "Heating Coil Rate", heating_coil.name.get)
  ...
  #cooling equipment
    ...
    chillers.each do |chiller|    
      ...
      timestep_chiller_cap = get_timeseries_array(sql, $env_period, $zone_time_step, "Chiller Evap Heat Trans Rate", chiller.name.get)
    ...
    one_speed_dx_cooling_coils.each do |one_speed_dx_cooling_coil|    
      ...
      timestep_one_speed_dx_cooling_coil_cap = get_timeseries_array(sql, $env_period, $zone_time_step, "DX Coil Total Cooling Rate", one_speed_dx_cooling_coil.name.get)
    ...
    two_speed_dx_cooling_coils.each do |two_speed_dx_cooling_coil|    
      ...
      timestep_two_speed_dx_cooling_coil_cap = get_timeseries_array(sql, $env_period, $zone_time_step, "DX Coil Total Cooling Rate", two_speed_dx_cooling_coil.name.get)
    ...
    cooling_towers.each do |cooling_towers|    
      ...
      timestep_cooling_towers_cap = get_timeseries_array(sql, $env_period, $zone_time_step, "Tower Heat Transfer", cooling_towers.name.get)
