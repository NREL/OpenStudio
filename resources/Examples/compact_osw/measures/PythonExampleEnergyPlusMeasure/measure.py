...
class PythonExampleEnergyPlusMeasure(openstudio.measure.EnergyPlusMeasure):
    ...
    def name(self):
        ...
        """
        return "Python Example EnergyPlus Measure"
...
PythonExampleEnergyPlusMeasure().registerWithApplication()
