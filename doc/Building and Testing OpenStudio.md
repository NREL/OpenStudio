...
- Update openstudiocore\cmakelists.txt to package the latest release notes pdf (ruby -I E:\Git\OS1\build\OSCore-prefix\src\OSCore-build\ruby\Release UpdateHVACLibrary.rb).
