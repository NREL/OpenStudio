...
MODELOBJECT_TEMPLATES(CoilChillerAirSourceVariableSpeed);
...
MODELOBJECT_TEMPLATES(CoilSystemHeatingDX);
MODELOBJECT_TEMPLATES(CoilSystemCoolingDX);
...
SWIG_MODELOBJECT(CoilChillerAirSourceVariableSpeed,1);
...
SWIG_MODELOBJECT(CoilSystemHeatingDX,1);
SWIG_MODELOBJECT(CoilSystemCoolingDX,1);
