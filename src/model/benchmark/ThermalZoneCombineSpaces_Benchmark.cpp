...
BENCHMARK(BM_CombineSpaces)->Unit(benchmark::kMillisecond)->RangeMultiplier(2)->Range(1, 1024)->Complexity();
...
BENCHMARK(BM_CombineSpacesInNZones)->Unit(benchmark::kMillisecond)->RangeMultiplier(2)->Range(4, 1024)->Complexity();
