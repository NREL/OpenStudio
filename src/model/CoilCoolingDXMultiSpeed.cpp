...
namespace model {
  ...
  namespace detail {
    ...
    ComponentType CoilCoolingDXMultiSpeed_Impl::componentType() const {
      return ComponentType::Cooling;
    }

    std::vector<FuelType> CoilCoolingDXMultiSpeed_Impl::coolingFuelTypes() const {
      return {FuelType::Electricity};
    }

    std::vector<FuelType> CoilCoolingDXMultiSpeed_Impl::heatingFuelTypes() const {
      return {};
    }

    std::vector<AppGFuelType> CoilCoolingDXMultiSpeed_Impl::appGHeatingFuelTypes() const {
      return {};
    }
