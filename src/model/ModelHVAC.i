...
MODELOBJECT_TEMPLATES(CoilChillerAirSourceVariableSpeedSpeedData);
...
MODELOBJECT_TEMPLATES(CoilLiquidDesiccantSimple);
...
SWIG_MODELOBJECT(CoilChillerAirSourceVariableSpeedSpeedData, 1);
...
SWIG_MODELOBJECT(CoilLiquidDesiccantSimple, 1);
