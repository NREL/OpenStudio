...
namespace model {
  ...
  ScheduleTypeRegistrySingleton::ScheduleTypeRegistrySingleton() {
    ...
    const ScheduleType scheduleTypes[] = {
      ...
      {"ZoneHVACExhaustControl", "Availability", "availabilitySchedule", false, "Availability", 0.0, 1.0},
      {"ZoneHVACExhaustControl", "Exhaust Flow Fraction", "exhaustFlowFractionSchedule", true, "", 0.0, 1.0},
      {"ZoneHVACExhaustControl", "Minimum Zone Temperature Limit", "minimumZoneTemperatureLimitSchedule", true, "Temperature", OptionalDouble(),
       OptionalDouble()},
      {"ZoneHVACExhaustControl", "Minimum Exhaust Flow Fraction", "minimumExhaustFlowFractionSchedule", true, "", 0.0, 1.0},
      {"ZoneHVACExhaustControl", "Balanced Exhaust Fraction", "balancedExhaustFractionSchedule", true, "", 0.0, 1.0},
