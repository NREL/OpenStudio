...
namespace model {
  ...
  ScheduleTypeRegistry::ScheduleTypeRegistry() {
    ...
    const ScheduleType scheduleTypes[] = {
      ...
      {"PumpVariableSpeedCondensate", "Pump Flow Rate", "pumpFlowRateSchedule", true, "", 0.0, 1.0},
      ...
      {"ZoneHVACBaseboardRadiantConvectiveSteam", "Availability", "availabilitySchedule", false, "Availability", 0.0, 1.0},
