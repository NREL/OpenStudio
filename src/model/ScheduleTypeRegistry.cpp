...
namespace model {
  ...
  ScheduleTypeRegistrySingleton::ScheduleTypeRegistrySingleton() {
    ...
    const ScheduleType scheduleTypes[] = {
      ...
      {"DistrictCooling", "Capacity Fraction", "capacityFractionSchedule", true, "Dimensionless", 0.0, 1.0},
      {"DistrictHeating", "Capacity Fraction", "capacityFractionSchedule", true, "Dimensionless", 0.0, 1.0},
      {"DistrictHeatingSteam", "Capacity Fraction", "capacityFractionSchedule", true, "Dimensionless", 0.0, 1.0},
