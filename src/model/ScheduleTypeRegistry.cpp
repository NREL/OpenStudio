...
namespace model {
  ...
  ScheduleTypeRegistrySingleton::ScheduleTypeRegistrySingleton() {
    ...
    const ScheduleType scheduleTypes[] = {
      ...
      {"DistrictHeating", "Capacity Fraction Schedule", "capacityFractionSchedule", true, "Dimensionless", 0.0, 1.0},
      {"DistrictHeatingSteam", "Capacity Fraction Schedule", "capacityFractionSchedule", true, "Dimensionless", 0.0, 1.0},
