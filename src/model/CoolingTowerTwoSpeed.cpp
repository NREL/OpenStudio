...
namespace model {
  ...
  namespace detail {
    ...
    CoolingTowerTwoSpeed_Impl::CoolingTowerTwoSpeed_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == CoolingTowerTwoSpeed::iddObjectType());
    }

    CoolingTowerTwoSpeed_Impl::CoolingTowerTwoSpeed_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == CoolingTowerTwoSpeed::iddObjectType());
    }

    CoolingTowerTwoSpeed_Impl::CoolingTowerTwoSpeed_Impl(const CoolingTowerTwoSpeed_Impl& other, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(other, model, keepHandle) {}
    ...
    const std::vector<std::string>& CoolingTowerTwoSpeed_Impl::outputVariableNames() const {
      ...
      static const std::vector<std::string> result{
        ...
        "Cooling Tower Inlet Temperature", "Cooling Tower Outlet Temperature", "Cooling Tower Mass Flow Rate", "Cooling Tower Fan Cycling Ratio",
        "Cooling Tower Operating Cells Count", "Cooling Tower Fan Speed Level", "Cooling Tower Bypass Fraction",
    ...
    bool CoolingTowerTwoSpeed_Impl::setFreeConvectionRegimeAirFlowRateSizingFactor(double freeConvectionRegimeAirFlowRateSizingFactor) {
      bool result =
        setDouble(OS_CoolingTower_TwoSpeedFields::FreeConvectionRegimeAirFlowRateSizingFactor, freeConvectionRegimeAirFlowRateSizingFactor);
      return result;
    }
    ...
    bool CoolingTowerTwoSpeed_Impl::setFreeConvectionRegimeUFactorTimesAreaValue(boost::optional<double> freeConvectionRegimeUFactorTimesAreaValue) {
      ...
      if (freeConvectionRegimeUFactorTimesAreaValue) {
        result =
          setDouble(OS_CoolingTower_TwoSpeedFields::FreeConvectionRegimeUFactorTimesAreaValue, freeConvectionRegimeUFactorTimesAreaValue.get());
      } else {
    ...
    bool CoolingTowerTwoSpeed_Impl::setFreeConvectionUFactorTimesAreaValueSizingFactor(double freeConvectionUFactorTimesAreaValueSizingFactor) {
      bool result =
        setDouble(OS_CoolingTower_TwoSpeedFields::FreeConvectionUFactorTimesAreaValueSizingFactor, freeConvectionUFactorTimesAreaValueSizingFactor);
      return result;
    }
    ...
    bool CoolingTowerTwoSpeed_Impl::setHeatRejectionCapacityandNominalCapacitySizingRatio(double heatRejectionCapacityandNominalCapacitySizingRatio) {
      bool result = setDouble(OS_CoolingTower_TwoSpeedFields::HeatRejectionCapacityandNominalCapacitySizingRatio,
    ...
    bool CoolingTowerTwoSpeed_Impl::setBasinHeaterOperatingSchedule(Schedule& schedule) {
      bool result =
        setSchedule(OS_CoolingTower_TwoSpeedFields::BasinHeaterOperatingScheduleName, "CoolingTowerTwoSpeed", "Basin Heater Operating", schedule);
      return result;
    }
    ...
    bool CoolingTowerTwoSpeed_Impl::setBlowdownMakeupWaterUsageSchedule(Schedule& schedule) {
      bool result = setSchedule(OS_CoolingTower_TwoSpeedFields::BlowdownMakeupWaterUsageScheduleName, "CoolingTowerTwoSpeed",
    ...
    bool CoolingTowerTwoSpeed_Impl::isDesignApproachTemperatureAutosized() const {
      bool result = false;
      boost::optional<std::string> value = getString(OS_CoolingTower_TwoSpeedFields::DesignApproachTemperature, true);
      if (value) {
        result = openstudio::istringEqual(value.get(), "autosize");
      }
      return result;
    ...
    bool CoolingTowerTwoSpeed_Impl::isDesignRangeTemperatureAutosized() const {
      bool result = false;
      boost::optional<std::string> value = getString(OS_CoolingTower_TwoSpeedFields::DesignRangeTemperature, true);
      if (value) {
        result = openstudio::istringEqual(value.get(), "autosize");
      }
      return result;
    ...
    std::vector<FuelType> CoolingTowerTwoSpeed_Impl::coolingFuelTypes() const {
      return {FuelType::Electricity};
    }

    std::vector<FuelType> CoolingTowerTwoSpeed_Impl::heatingFuelTypes() const {
      return {};
    }

    std::vector<AppGFuelType> CoolingTowerTwoSpeed_Impl::appGHeatingFuelTypes() const {
      return {};
    }
  ...
  std::vector<std::string> CoolingTowerTwoSpeed::performanceInputMethodValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_CoolingTower_TwoSpeedFields::PerformanceInputMethod);
  }

  std::vector<std::string> CoolingTowerTwoSpeed::evaporationLossModeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_CoolingTower_TwoSpeedFields::EvaporationLossMode);
  }

  std::vector<std::string> CoolingTowerTwoSpeed::blowdownCalculationModeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_CoolingTower_TwoSpeedFields::BlowdownCalculationMode);
  }

  std::vector<std::string> CoolingTowerTwoSpeed::cellControlValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_CoolingTower_TwoSpeedFields::CellControl);
  }
  ...
  void CoolingTowerTwoSpeed::autosizeDesignApproachTemperature() {
    return getImpl<detail::CoolingTowerTwoSpeed_Impl>()->autosizeDesignApproachTemperature();
  }
  ...
  void CoolingTowerTwoSpeed::autosizeDesignRangeTemperature() {
    return getImpl<detail::CoolingTowerTwoSpeed_Impl>()->autosizeDesignRangeTemperature();
  }
