...
INSTANTIATE_TEST_SUITE_P(XMLValidatorFixture, GbXMLValidatorParametrizedFixture,
                         ::testing::Values(std::make_tuple("gbxml/3951_Geometry_bug.xml", 0, 7),
                                           ...
                                           std::make_tuple("gbxml/seb.xml", 0, 16),
                                           std::make_tuple("gbxml/simpleBox_vasari.xml", 0, 27),
                                           std::make_tuple("gbxml/TestCube.xml", 0, 8),
                                           std::make_tuple("gbxml/TestCubeAlternateUnits.xml", 0, 8),
                                           std::make_tuple("gbxml/TestSchedules.xml", 0, 16),
                                           std::make_tuple("gbxml/TropicBird.xml", 0, 110),
                                           std::make_tuple("gbxml/TwoStoryOffice_Trane.xml", 0, 236),
                                           std::make_tuple("gbxml/ZNETH.xml", 0, 204),
