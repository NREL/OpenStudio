...
namespace alfalfa {
  ...
  {
   public:
    AlfalfaConstant(float value) : AlfalfaComponent("Constant", ComponentCapabilities::Input | ComponentCapabilities::Output) {
      m_root["value"] = value;
    }
  };
  ...
  {
   public:
    AlfalfaMeter(const std::string& meter_name) : AlfalfaComponent("Meter", ComponentCapabilities::Output) {
