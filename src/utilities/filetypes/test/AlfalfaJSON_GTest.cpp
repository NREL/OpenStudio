...
TEST(AlfalfaJSON, basic_export) {
  AlfalfaJSON alfalfa;
  AlfalfaPoint constant = alfalfa.exposeConstant(17, "hello");
  ...
  AlfalfaPoint meter = alfalfa.exposeMeter("Electricity:Facility");
  ...
  AlfalfaPoint actuator = alfalfa.exposeActuator("thing1", "thing2", "thing3");
  ...
  AlfalfaPoint output_variable = alfalfa.exposeOutputVariable("key", "name");
  ...
  AlfalfaPoint global_variable = alfalfa.exposeGlobalVariable("name");
...
TEST(AlfalfaJSON, json_serialization) {
  ...
  float value = 10.0;
  AlfalfaPoint constant = alfalfa.exposeConstant(value, "example_name");
  ...
  AlfalfaPoint actuator = alfalfa.exposeActuator(act_component_name, act_component_type, act_control_type, point_name);
  ...
  AlfalfaPoint global_variable = alfalfa.exposeGlobalVariable(global_variable_name, point_name);
  ...
  AlfalfaPoint meter = alfalfa.exposeMeter(meter_name, point_name);
  ...
  AlfalfaPoint output_variable = alfalfa.exposeOutputVariable(output_variable_key, output_variable_name, point_name);
