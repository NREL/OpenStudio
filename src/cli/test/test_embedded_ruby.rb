...
#  end
  ...
  def test_ffi
    ...
    Math.stub(:sin, 100.0) {
      # This creates a Module called LibC that loads the sin function from LIBC
      require File.expand_path(File.join(File.dirname(__FILE__), "ffi_helper"))
      assert(LibC.sin(Math::PI / 2) == 1.0)
