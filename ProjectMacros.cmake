...
macro(MAKE_SWIG_TARGET NAME SIMPLENAME KEY_I_FILE I_FILES PARENT_TARGET PARENT_SWIG_TARGETS)
  ...
  elseif(UNIX)
    ...
    if("${CMAKE_CXX_COMPILER_ID}" MATCHES "^(Apple)?Clang$")
      ...
      set_target_properties(${swig_target} PROPERTIES COMPILE_FLAGS "-Wno-dynamic-class-memaccess -Wno-deprecated-declarations -Wno-sign-compare -Wno-register -Wno-sometimes-uninitialized -Wno-misleading-indentation")
    else()
  ...
  if(BUILD_PYTHON_BINDINGS)
    ...
    elseif(UNIX)
      if(APPLE AND NOT CMAKE_COMPILER_IS_GNUCXX)
        set_target_properties(${swig_target} PROPERTIES COMPILE_FLAGS "-Wno-dynamic-class-memaccess -Wno-deprecated-declarations -Wno-sign-compare -Wno-sometimes-uninitialized -Wno-misleading-indentation")
      else()
  ...
  if(BUILD_JAVA_BINDINGS)
    ...
    elseif(UNIX)
      set_target_properties(${swig_target} PROPERTIES COMPILE_FLAGS "-Wno-deprecated-declarations -Wno-sign-compare -Wno-sometimes-uninitialized -Wno-misleading-indentation")
    endif()
  ...
  if(BUILD_V8_BINDINGS)
    ...
    elseif(UNIX)
      set_target_properties(${swig_target} PROPERTIES COMPILE_FLAGS "-DBUILDING_NODE_EXTENSION -Wno-deprecated-declarations -Wno-sign-compare -Wno-sometimes-uninitialized -Wno-misleading-indentation")
    endif()
