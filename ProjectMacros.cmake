...
macro(MAKE_SWIG_TARGET NAME SIMPLENAME KEY_I_FILE I_FILES PARENT_TARGET PARENT_SWIG_TARGETS)
  ...
  if(BUILD_CSHARP_BINDINGS)
    ...
    if( name_found GREATER -1 )
      ...
      elseif(APPLE)
        set(CSHARP_OUTPUT_NAME "libopenstudio_translators_csharp.dylib")
      else()
    ...
    if( name_found GREATER -1 )
      ...
      elseif(APPLE)
        set(CSHARP_OUTPUT_NAME "libopenstudio_model_csharp.dylib")
      else()
      ...
      elseif(APPLE)
        set(CSHARP_OUTPUT_NAME "libopenstudio_csharp.dylib")
      else()
